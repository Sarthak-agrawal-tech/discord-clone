...
export const ServerChannel = ({
  ...
  return(
    ...
    >
        <Icon className="flex-shrink-0 w-5 h-5 text-zinc-500 dar:text-zinc-400"/>
        ...
        params?.channelId === channel.id && "text-primary dark:group-hover:text-white dark-text-zinc-200"
        )}>
          {channel.name}
        </p>
